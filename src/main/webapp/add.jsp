...
<body>
	...
	<table>
            <tr>
                <td><h3>title</h3><p><input type="text" name="description" required id="description"/></p></td>
                <td><h3>start</h3><p><input type="date" required name="date" id="date"/></p></td>
                <td><h3>finish</h3><p><input type="text" required name="time" id="time"/></p></td>
            </tr>
            <tr>
                <td colspan="2">
